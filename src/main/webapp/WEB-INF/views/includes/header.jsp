    ...
    <div class="nav-wrap">
        <nav class="navbar">
            ...
            <ul class="navbar__menu">
                <div class="test">
                    <li>
                    	<a href="/notice"><img src="/resources/img/hs_img/btn_change_community.svg" alt="바꾸기버튼"
        ...
        <div class="menu">
            <div class="menu-wrap">
                <div class=" row">
                    ...
                    <a href="/product/getGList">
                        <li class="col-md-4 menuli m_tile">
                            <img src="/resources/img/hs_img/btn_leap_icon.svg" class="himg">굿즈
                        </li>
                    </a>
                    <!-- <li class="col-sm menuli m_br">*</li> -->
                    <a href="/product/getNList">
                        <li class="col-md-4 menuli m_tile">
                            <img src="/resources/img/hs_img/btn_leap_icon.svg" class="himg">
                            닌텐도 용품
                        </li>
